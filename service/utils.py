...
def get_ethusd_price(amount: float) -> float:
    ...
    pool = UniswapV3Connector(
        ...
        zfo=True,
        token0=Token(address='0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', decimals=18, symbol='WETH'),
        token1=Token(address='0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', decimals=6, symbol='USDC'),
        fees=0.0005,
    )
